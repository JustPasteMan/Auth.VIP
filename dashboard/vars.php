				...
				<div class="main-content app-content mt-0">
                                ...
                                <div class="card">
                                    <div class="dt-card__header">
                                        <div class="card-header">
                                            <h3 class="card-title">Var creation form : </h3>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <p class="text-muted card-sub-title">Form with which you can create server sided variables that can be used with the class.</p> 
                                        ...
                                        <div class="form-group">
                                            <label for="var_value">Variable name</label>
                    ...
                    <form method="post">
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Var management : </h3>
                                </div>
                                <div class="dt-card__body">
                                    <div class="card-body">
                                        <div class="table-responsive export-table" >
                                        <p class="text-muted card-sub-title">Where all the generated variables are listed, you can edit it and/or delete its value.</p> 
