...
if(!$is_premium && (!empty($_POST) || !empty($_FILES)) ){
    die("Your account isn't premium, file uploading is a feature only accessible to premium users");
}
                        ...
                        <div class="row">
                            <div class="col-xl-10 col-sm-10 col-2">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <p class="text-muted card-sub-title">Form with which you can upload files that will be used in your program.</p>
                                        <div class="form-group">
                                            <label for="file_name">File name</label>
                                            <input type="text" class="form-control" id="file_name" name="file_name" placeholder="File Name">
                                            <small id="help_fn" class="form-text">This is the identifier that'll be used to fetch the file</small>
                                        </div>
                                        <div class="form-group">
                                            <input type="file" class="form-control" id="file_to_upload" name="file_to_upload" >  
                                        </div>
                        ...
                        <div class="col-xl-10 col-sm-10 col-2">
                            <div class="card">
                                ...
                                <div class="dt-card__body">
                                    <div class="card-body">
                                        <p class="text-muted card-sub-title">Where all the uploaded files are listed, you can edit and delete them. </p>
                                        ...
                                        <?php if(isset($_POST['edit_file'])) { ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="file" class="form-control" id="new_file" name="new_file" >                                            </div>
