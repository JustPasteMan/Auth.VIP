                        ...
                        <div class="row">
                            <div class="col-xl-10 col-sm-10 col-1">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <p class="text-muted card-sub-title">This button will clear all your logs, be careful.</p> 
                                        <button type="submit" name="purge_all_logs" class="btn btn-primary">Purge all logs</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-10 col-sm-10 col-2">
                            <div class="card">
                                ...
                                <div class="dt-card__body">
                                    <div class="card-body">
                                        <p class="text-muted card-sub-title">All the logs are listed here.</p>
